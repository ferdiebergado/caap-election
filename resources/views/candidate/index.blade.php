...
<div class="card">
    <div class="card-header">
        <div class="container">
            <div class="row">            
                <div class="col-6">
                    <h5 class="card-title mt-2 mb-1"><i class="s7 s7-user"></i> {{ ucfirst($plural) }}</h5>
                </div>
                <div class="col-6">
...
{ name: 'election.title', title: 'Election', data: 'election.title', width: '25%' },
{ name: 'voter.fullname', title: 'Name', data: 'voter.fullname', width: '35%' },
{ name: 'position.name', title: 'Position', data: 'position.name', width: '20%' },
